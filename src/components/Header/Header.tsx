  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuClose}>
        <IconButton size="large" aria-label="add friend" color="inherit">
          <PersonAdd />
        </IconButton>
        <p>Add Friend</p>
      </MenuItem>
      <MenuItem onClick={handleMenuClose}>
        <IconButton size="large" aria-label="account settings" color="inherit">
          <Settings />
        </IconButton>
        <p>Settings</p>
      </MenuItem>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItemLink to="/inbox" primary="Inbox" icon={<MailIcon />} />
